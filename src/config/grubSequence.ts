...
export const GRUB_SEQUENCE_STEPS: BootStep[] = [
  ...
  },
  {
    ...
    depth: 1,
    highlight: ['cpuBsp', 'ram'],
    console: ['startup_32: decompression stub'],
    signals: [],
  },
  {
    id: 'kern-startup64',
    ...
    depth: 1,
    highlight: ['cpuBsp', 'ram'],
    console: ['building temporary page tables', 'CR4.PAE = 1, EFER.LME = 1, CR0.PG = 1', 'long mode entered'],
    signals: [
      { route: ['cpuBsp', 'ram'], color: KERNEL, label: 'page tables', particles: 8, spread: 0.5 },
    ],
  },
  {
    id: 'kern-extract',
  ...
  },
  {
    ...
    depth: 1,
    highlight: ['cpuBsp', 'ram'],
    console: ['jmp *%rax  -> real startup_64'],
    signals: [
      { route: ['ram', 'cpuBsp'], color: KERNEL, particles: 14, spread: 0.6, persist: true },
    ],
  },
  {
    id: 'kern-x86-start',
    ...
    depth: 1,
    highlight: ['cpuBsp', 'ram'],
    console: ['x86_64_start_kernel()', 'permanent page tables installed'],
    signals: [],
  },
  {
    id: 'kern-reservations',
    phase: 'os',
    ...
    depth: 1,
    highlight: ['ram'],
    console: ['reserve: kernel text/data', 'reserve: initrd 0x7d200000 +42M'],
    signals: [
      { route: ['cpuBsp', 'ram'], color: KERNEL, label: 'reserve', particles: 8, spread: 0.5 },
    ],
  },
  {
    id: 'kern-start-kernel',
    phase: 'os',
    ...
    console: [
      ...
      '[    0.000000] Command line: root=/dev/nvme0n1p2 rw quiet',
    ],
    signals: [
      { route: ['cpuBsp', 'chipset'], color: KERNEL, particles: 10, spread: 0.4, persist: true },
      { route: ['cpuBsp', 'ram'], color: KERNEL, particles: 10, delay: 0.3, spread: 0.4, persist: true },
    ],
  },
];
